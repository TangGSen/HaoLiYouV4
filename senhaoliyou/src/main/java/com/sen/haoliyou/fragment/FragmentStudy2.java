 ...
 */
public class FragmentStudy2 extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    protected View initViews(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.fragment_study2, container, false);
...
//        study_lesson_recyclerview.setHasFixedSize(true);
        ...
        swipe_refresh_widget.setColorSchemeColors(R.color.theme_color);
